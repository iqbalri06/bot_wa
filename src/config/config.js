module.exports = {
    botName: 'TechBalion',
    owner: ['6281291544061@s.whatsapp.net', '628987654321@s.whatsapp.net'],
    prefix: '!',
    botInfo: {
        name: 'TechBalion',
        version: '2.0.0',
    ...
    maintenance: {
        ...
        allowedUsers: ['6281291544061@s.whatsapp.net', '628987654321@s.whatsapp.net'] // Same as owner by default
    },
    commands: {
        start: ['hi', 'halo', 'mulai'],
